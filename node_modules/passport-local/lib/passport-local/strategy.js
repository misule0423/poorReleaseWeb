...
function Strategy(options, verify) {
  ...
  this._firstNameField = options.firstNameField || 'fname';
  this._lastNameField = options.lastNameField || 'lname';
...
Strategy.prototype.authenticate = function(req, options) {
  ...
  var fname = lookup(req.body, this._firstNameField) || lookup(req.query, this._firstNameField);
  var lname = lookup(req.body, this._lastNameField) || lookup(req.query, this._lastNameField);
  ...
  if (self._passReqToCallback) {
    this._verify(req, username, password, fname, lname, year, month, day, gender, verified);
  } else {
